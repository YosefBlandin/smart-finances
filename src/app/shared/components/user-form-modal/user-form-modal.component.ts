    ...
    implements AfterViewInit, AfterContentChecked
{
    ...
    public itemTypes: { value: string | number; label: string }[] = [
        { label: 'Profit', value: 'P' },
        { label: 'Expense', value: 'E' },
    ];
    public frequencies: { value: string | number; label: string }[] = [
    ...
    public personalInfoForm: FormGroup = this.formBuilder.group({
        ...
        localPhone: this.formBuilder.control('', {
            nonNullable: true,
    ...
    public permissionsForm: FormGroup = this.formBuilder.group({
        channelId: this.formBuilder.control('1', {
            nonNullable: true,
            validators: [Validators.required, Validators.maxLength(1)],
        }),
    ...
    public ngAfterViewInit(): void {
        this.matStepper.selectedIndexChange.subscribe(
            this.currentStepIndex$.set
        );
        this.allFormsStatusChanges.subscribe(
            this.handleAllFormsStatus.bind(this)
        );
